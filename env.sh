VAULT=${VAULT:-/Users/bishbr/box/borg-encrypted}
BORG_HOME=$HOME/src/borg
BORG_MANIFESTS_HOME=$BORG_HOME/manifests
EXCLUDE=$BORG_HOME/exclude
OPTIONS="--exclude-from $EXCLUDE --one-file-system --verbose --stats --compression lzma --list --lock-wait 60 --exclude-if-present .borgexclude"
